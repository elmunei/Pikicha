...
//  pikicha
//
//  Created by Elvis Tapfumanei on 6/5/17.
...
class feedVC: UITableViewController {
    ...
    override func viewDidLoad() {
        ...
        self.navigationController?.navigationBar.titleTextAttributes = [ NSFontAttributeName: UIFont(name: "BalooChettan", size: 25)!]
...
//    }
    ...
    // refreshign function after like to update digit
    func refresh() {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // logic  to show: seconds, minutes, hours, days or weeks
        ...
        // count total comments of shown post
        let countComments = PFQuery(className: "comments")
        countComments.whereKey("to", equalTo: cell.uuidLbl.text!)
        countComments.countObjectsInBackground { (count, error) -> Void in
           // cell.commentLbl.text = "\(count)"
           // print(cell.commentLbl.text = "\(count) comments")
        }
    ...
    @IBAction func moreBtn_click(_ sender: AnyObject) {
        ...
        let complain = UIAlertAction(title: "Report", style: .default) { (UIAlertAction) -> Void in
            ...
            let complainObj = PFObject(className: "report")
            ...
            complainObj.saveInBackground(block: { (success, error) -> Void in
                if success {
                    ...
                    _ = alert.showSuccess("🗣", subTitle: "Your report has been submitted. We will review your complaint. Thank You")
                } else {
                    let alert = SCLAlertView()
        ...
        let menu = UIAlertController(title: "Action", message: nil, preferredStyle: .actionSheet)
