...
class postsCell: UITableViewCell {
    ...
    override func awakeFromNib() {
        ...
        // double tap to like
        let likeTap = UITapGestureRecognizer(target: self, action: #selector(postsCell.likeTap))
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraints(
            withVisualFormat: "V:|-10-[ava(30)]-10-[pic(\(pictureWidth))]-9-[like(25)]",
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraints(
            withVisualFormat: "V:[like]-15-[title]-10-|",
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraints(
            withVisualFormat: "V:[pic]-13-[likes]",
        ...
        self.contentView.addConstraints(NSLayoutConstraint.constraints(
            withVisualFormat: "H:|-15-[like(25)]-8-[likes]-20-[comment(30)]",
    ...
    func likeTap() {
        ...
        let likePic = UIImageView(image: UIImage(named: "heart.png"))
