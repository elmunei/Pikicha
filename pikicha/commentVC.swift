...
class commentVC: UIViewController, UITextViewDelegate, UITableViewDelegate, UITableViewDataSource {
    ...
    func loadComments() {
        ...
        countQuery.countObjectsInBackground (block: { (count, error) -> Void in
            ...
            query.skip = Int(Int64(count - self.page))
...
//            })
        ...
        // ACTION 2. Mention or respond  to someone
        ...
        let complain = UITableViewRowAction(style: .normal, title: "  ") { (action:UITableViewRowAction, indexPath:IndexPath) -> Void in
            ...
            // send report to server regarding selected comment
        ...
        address.backgroundColor = UIColor(patternImage: UIImage(named: "answer.png")!)
        complain.backgroundColor = UIColor(patternImage: UIImage(named: "report.png")!)
